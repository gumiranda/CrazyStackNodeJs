...
export type AddSilvioSantos = (data: SilvioSantosData) => Promise<SilvioSantosEntity | null>;
export type AddSilvioSantosSignature = (addSilvioSantos: AddSilvioSantosRepository) => AddSilvioSantos;
