...
describe("LoadAccountByPage", () => {
  ...
  beforeAll(async () => {
    ...
    loadAccountByPageRepository.loadAccountByPage.mockResolvedValue(fakeAccountPaginated);
  });
  beforeEach(() => {
  ...
  it("should call loadAccountByPage of LoadAccountByPageRepository with correct values", async () => {
    ...
    expect(loadAccountByPageRepository.loadAccountByPage).toHaveBeenCalledWith(fakeQuery);
