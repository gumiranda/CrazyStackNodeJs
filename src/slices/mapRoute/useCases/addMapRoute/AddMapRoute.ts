...
import { MapRouteEntity, CreateRouteDto, MapRouteData } from "@/slices/mapRoute/entities";
...
export const addMapRoute: AddMapRouteSignature =
  ...
  async (data: CreateRouteDto) => {
    ...
    return addMapRouteRepository.addMapRoute(new MapRouteEntity(mapRoute as MapRouteData));
  };
