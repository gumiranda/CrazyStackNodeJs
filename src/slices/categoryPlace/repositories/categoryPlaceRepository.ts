...
import { CategoryPlaceData, CategoryPlacePaginated } from "@/slices/categoryPlace/entities";
import {
        ...
        UpdateCategoryPlaceRepository
{
    ...
    async addCategoryPlace(categoryPlace: CategoryPlaceData): Promise<CategoryPlaceData | null> {
    ...
    async updateCategoryPlace(query: Query, data: CategoryPlaceData): Promise<CategoryPlaceData | null> {
