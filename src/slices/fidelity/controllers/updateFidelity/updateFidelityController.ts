...
import { UpdateFidelity } from "@/slices/fidelity/useCases";

export class UpdateFidelityController extends Controller {
  constructor(
    private readonly validationQuery: Validation,
    private readonly validationBody: Validation,
    private readonly updateFidelity: UpdateFidelity
  ) {
    super();
  }
