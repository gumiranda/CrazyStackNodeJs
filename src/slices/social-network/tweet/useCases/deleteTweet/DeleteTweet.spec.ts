...
import { DeleteTweetRepository } from "@/slices/social-network/tweet/repositories/contracts";
...
describe("deleteTweet", () => {
  ...
  it("should rethrow if deleteTweet of DeleteTweetRepository throws", async () => {
    deleteTweetRepository.deleteTweet.mockRejectedValueOnce(new Error("any_error"));
