...
import { fakeTrendPaginated } from "@/slices/social-network/trend/entities/TrendEntity.spec";
...
describe("LoadTrendByPage", () => {
  ...
  it("should call loadTrendByPage of LoadTrendByPageRepository with correct values", async () => {
    ...
    expect(loadTrendByPageRepository.loadTrendByPage).toHaveBeenCalledWith(fakeQuery);
