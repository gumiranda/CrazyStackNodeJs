...
import { FollowEntity } from "@/slices/follow/entities";
import { DeleteFollowRepository } from "@/slices/follow/repositories/contracts";
...
describe("deleteFollow", () => {
    ...
    it("should rethrow if deleteFollow of DeleteFollowRepository throws", async () => {
        deleteFollowRepository.deleteFollow.mockRejectedValueOnce(
            new Error("any_error")
        );
